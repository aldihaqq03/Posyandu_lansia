...
<head>
    ...
    <title>Tambah Lansia - Posyandu</title>
        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-person-plus"></i> Tambah Data Lansia</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('lansia.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror" value="{{ old('nik') }}" required placeholder="Masukkan 16 digit NIK">
                            @error('nik')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_lansia" id="nama_lansia" class="form-control @error('nama_lansia') is-invalid @enderror" value="{{ old('nama_lansia') }}" required>
                            @error('nama_lansia')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="riwayat_penyakit" id="riwayat_penyakit" class="form-control @error('riwayat_penyakit') is-invalid @enderror" rows="3">{{ old('riwayat_penyakit') }}</textarea>
