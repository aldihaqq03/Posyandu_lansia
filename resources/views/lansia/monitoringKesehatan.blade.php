...
<main class="monitoring-wrap">
    ...
    {{-- ── TAB NAVIGASI GRAFIK ── --}}
    <div class="mon-tabs">
        <button class="mon-tab-btn active" data-tab="tensi"><i class="fa-solid fa-heart-pulse"></i> Tekanan Darah</button>
        ...
        <div class="mon-chart-card">
            <div class="mon-chart-header">
                ...
                <div class="mon-zones">
                    ...
                    <button class="mon-btn-detail" onclick="openDetailModal('tensi')" title="Lihat Detail Data"><i class="fa-solid fa-table"></i> Lihat Detail</button>
                </div>
            </div>
        ...
        <div class="mon-chart-card">
            <div class="mon-chart-header">
                ...
                <div class="mon-zones">
                    ...
                    <button class="mon-btn-detail" onclick="openDetailModal('gula')" title="Lihat Detail Data"><i class="fa-solid fa-table"></i> Lihat Detail</button>
                </div>
            </div>
        ...
        <div class="mon-chart-card">
            <div class="mon-chart-header">
                ...
                <div class="mon-zones">
                    ...
                    <button class="mon-btn-detail" onclick="openDetailModal('kolesterol')" title="Lihat Detail Data"><i class="fa-solid fa-table"></i> Lihat Detail</button>
                </div>
            </div>
    ...
    <div class="mon-tab-content" id="tab-bb">
        <div class="mon-chart-card">
            <div class="mon-chart-header">
                ...
                <div class="mon-zones">
                    <button class="mon-btn-detail" onclick="openDetailModal('bb')" title="Lihat Detail Data"><i class="fa-solid fa-table"></i> Lihat Detail</button>
                </div>
            </div>
    ...
    <div class="mon-modal-overlay" id="detail-modal" style="display:none;">
        <div class="mon-modal-content">
            <div class="mon-modal-header">
                ...
                <button class="mon-modal-close" onclick="closeDetailModal()"><i class="fa-solid fa-xmark"></i></button>
            </div>
