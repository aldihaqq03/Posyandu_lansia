...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('lansia.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-lg"></i> Tambah Lansia
            </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="{{ route('lansia.show', $l->id_lansia) }}" class="btn btn-info">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('lansia.edit', $l->id_lansia) }}" class="btn btn-warning">
