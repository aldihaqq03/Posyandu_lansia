                ...
                <div class="form-grid profile-form-grid">
                    <div class="form-group full">
                        ...
                        <input type="text" name="nama" class="form-control" value="{{ old('nama', $user->nama) }}"
                            data-profile-field required readonly>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="whatsapp" class="form-control"
                            value="{{ old('whatsapp', $user->whatsapp) }}" data-profile-field readonly>
                        @error('whatsapp')
                            <small style="color:var(--danger)">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jabatan" class="form-control"
                            value="{{ old('jabatan', $user->jabatan) }}" required readonly
