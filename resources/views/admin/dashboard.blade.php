...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div>
            <div class="breadcrumb">
                <span>Admin</span> <i class="fa fa-chevron-right"></i> <span>Dashboard</span>
            </div>
            <h1 class="page-title">Sekarang di Dashboard</h1>
    ...
    <div class="stats-grid">
        <div class="stat-card border-success">
            ...
            <div class="stat-content">
                ...
                <i class="fa fa-users stat-icon-fa color-success"></i>
            </div>
        </div>
        <div class="stat-card">
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-card">
            ...
            <p class="sub-text" style="margin-top: -15px; margin-bottom: 15px;">Distribusi prevalensi kondisi kesehatan berdasarkan skrining terakhir.</p>
            ...
            <div class="list-items">
                @forelse($jadwalMendatang as $jadwal)
                    <div class="list-item-row">
                        <div>
                            <span class="main-text">{{ $jadwal->nama_kegiatan ?? 'Posyandu Lansia' }}</span>
