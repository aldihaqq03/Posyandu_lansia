...
<div class="resep-row">
    <div class="resep-row-inner">
        ...
        <input type="text" name="resep[{{ $i }}][dosis]" class="form-control" placeholder="Dosis (cth: 500mg)"
            value="{{ $r['dosis'] ?? '' }}">
        <input type="text" name="resep[{{ $i }}][frekuensi]" class="form-control" placeholder="Frekuensi (cth: 3x1)"
            value="{{ $r['frekuensi'] ?? '' }}">
