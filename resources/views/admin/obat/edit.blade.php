        ...
        <div class="container">
            <header class="page-header">
                <div class="header-info">
                    ...
                    <p class="page-subtitle">Perbarui informasi obat.</p>
                </div>
            </header>
            ...
            <section class="card" style="padding: 30px;">
                ...
                <form action="{{ route('obat.update', $obat->id_obat) }}" method="POST">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" id="tipe_obat" name="tipe_obat" value="{{ old('tipe_obat', $obat->tipe_obat) }}" 
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <textarea id="keterangan" name="keterangan" 
                            ...
                            rows="4"
                            style="width: 100%; padding: 10px 12px; border: 1px solid #E5E7EB; border-radius: 6px; font-size: 14px;">{{ old('keterangan', $obat->keterangan) }}</textarea>
                    </div>
